...
var usernameValidityChecks = [
    {
        ...
        invalidityMessage: 'User name parameter is required',
        element: document.querySelector('label[for="username"] .input-requirements li:nth-child(1)')
    },
    {
        isInvalid: function(input) {
            return !input.value.match(/^[0-9а-яА-Яa-zA-Z]+$/g);
        },
        invalidityMessage: 'Please enter syntactically correct name',
...
// 		},
// 		invalidityMessage: 'User surname is required',
// 		element: document.querySelector('label[for="surname"] .input-requirements li:nth-child(1)')
// 	},
// 	{
// 		isInvalid: function(input) {
// 			return !input.value.match(/^[A-Z][-'a-zA-Z]+$/g);
// 		},
// 		invalidityMessage: 'Please enter syntactically correct surname',
...
var ageValidityChecks = [
    {
        isInvalid: function(input) {
            ...
            return age < 18 || age > 120 || !input.value.match(/^[0-9]+$/g);
        },
        invalidityMessage: 'You must be of legal age (over 18)',
